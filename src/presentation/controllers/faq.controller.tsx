...
export function useFaqController(): FaqModel {
  ...
  const questions: FaqQuestion[] = [
    {
      ...
      answer: 'Turpis at malesuada orci ultricies ipsum amet sed cras. Enim ut urna feugiat ultrices semper quisque at. Viverra lectus ut a gravida aliquet cras est lectus ullamcorper. Elementum diam iaculis neque arcu, aliquet consectetur.'
    },
    {
      id: '02',
  ...
  return {
    ...
    subtitle: 'Separamos algumas perguntas e respostas que podem te ajudar na sua decisão',
    cards,
    questions
  }
}
